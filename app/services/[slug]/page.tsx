        ...
        <ul className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
          {serviceAreas.map((area) => (
            <li key={area.slug}>
              <Link
                href={`/${area.slug}/`}
                className="flex items-center justify-between gap-2 border border-[#E5E5E5] bg-white px-4 py-3 font-display text-base font-black uppercase tracking-tight text-black transition-colors duration-150 hover:border-[#F96302] hover:text-[#F96302]"
              >
                <span>{area.city}</span>
